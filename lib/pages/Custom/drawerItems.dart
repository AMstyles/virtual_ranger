...
class DrawerItems {
  static final profile = DrawerItem(
      title: 'Profile', image: 'lib/icons/icons8_male_user_72.png', num: 0);
  static final dealsAndNews = DrawerItem(
      title: 'Deals & News', image: 'lib/icons/icons8_bull_72.png', num: 1);

  static final guide = DrawerItem(
      title: 'Guide', image: 'lib/icons/icons8_giraffe_72.png', num: 2);
  ...
  static final rules = DrawerItem(
      title: 'Rules', image: 'lib/icons/icons8_elephant_72.png', num: 6);
  static final businessListings = DrawerItem(
      title: 'Business Listings',
      image: 'lib/icons/icons8_year_of_snake_72.png',
      num: 7);
